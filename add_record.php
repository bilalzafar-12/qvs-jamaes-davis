...
if(isset($_POST['searchBtn'])) {
	...
	$sql = "INSERT INTO tblcandidate (firstname, lastname, certificateno, country, date_of_award, dob, institution, qualification, gradyear) VALUES ('$firstName', '$lastName', '$certificateNo', '$tertiary', '$dateOfAward', '$dateOfBirth', '$nameOfInstitution', '$qualification','$gradyear')";
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="date" class="form-control" style="width: 100%;" name="dateOfAward" required>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="date" class="form-control" style="width: 100%;" name="dateOfBirth" required>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="text" class="form-control" name="nameOfInstitution" required>
												</div>
											</div>
										</div>
										<div class="col-md-6">
								...
								<div class="col-md-12">
									<div class="form-group">
										<div class="col-sm-offset-2 col-sm-10">
											<button type="submit" name="searchBtn" class="btn btn-danger">Add Record</button>
										</div>
									</div>
								</div>
							</div>
