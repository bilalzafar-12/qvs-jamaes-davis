...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2021 at 08:30 AM
...
CREATE TABLE `users` (
  ...
  `securitygroup` tinyint(4) NOT NULL,
  `blockstatus` tinyint(4) NOT NULL,
